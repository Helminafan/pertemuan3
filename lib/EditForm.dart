...
class _EditFormState extends State<EditForm> {
  ...
  void initState() {
    ...
    _jeniskelamin = pelanggan.jeniskelamin;
    ...
    _fotoPath = pelanggan.foto;
    imgFile = File(_fotoPath);
  }
  ...
  void _submitForm() async {
    if (_formKey.currentState!.validate()) {
      ...
      DatabaseHelper.instance.updatePelanggan(formData);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Edit Formulir Data')),
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Text('Ssimpan Perubahan', style: TextStyle(color: Colors.white)),
                  ),
                ),
              ],
            ),
